...
import { IInfo, IUserInfo } from "./info.interface";
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1 w-fit">
              ...
              <a
                ...
                className="text-base text-white bg-black px-2 py-1 rounded flex items-center gap-1"
              >
                <svg
            ...
            <div>
              ...
              <h3 className="text-base text-gray-700">
                {filterDateAndTime(data?.timeRegistered)}
              </h3>
            </div>
            {isListAccess && (
              <button
            ...
            )}
            {
              ...
              edit && (
                <button
                  ...
                  className="bg-red-500 flex items-center text-white p-2 w-full justify-center gap-2 rounded text-base hover:bg-gray-800"
                >
                  <svg
                    width="18"
                    height="18"
                  ...
                  >
                    <g clipPath="url(#clip0_55_352)">
                      ...
                      />
                      <path
                        d="M6.66667 12.0001C6.84348 12.0001 7.01305 11.9298 7.13807 11.8048C7.2631 11.6798 7.33333 11.5102 7.33333 11.3334V7.33341C7.33333 7.1566 7.2631 6.98703 7.13807 6.86201C7.01305 6.73699 6.84348 6.66675 6.66667 6.66675C6.48986 6.66675 6.32029 6.73699 6.19526 6.86201C6.07024 6.98703 6 7.1566 6 7.33341V11.3334C6 11.5102 6.07024 11.6798 6.19526 11.8048C6.32029 11.9298 6.48986 12.0001 6.66667 12.0001Z"
                        fill="white"
                      />
                      <path
                        d="M9.33341 12.0001C9.51023 12.0001 9.67979 11.9298 9.80482 11.8048C9.92984 11.6798 10.0001 11.5102 10.0001 11.3334V7.33341C10.0001 7.1566 9.92984 6.98703 9.80482 6.86201C9.67979 6.73699 9.51023 6.66675 9.33341 6.66675C9.1566 6.66675 8.98703 6.73699 8.86201 6.86201C8.73699 6.98703 8.66675 7.1566 8.66675 7.33341V11.3334C8.66675 11.5102 8.73699 11.6798 8.86201 11.8048C8.98703 11.9298 9.1566 12.0001 9.33341 12.0001Z"
                        fill="white"
                      />
                    </g>
                    <defs>
