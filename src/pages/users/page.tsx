                        ...
                        <tbody className='flex flex-col w-full justify-center items-center gap-2'>
                            ...
                            { (users.length > 0) ? users.map( user => {
                                ...
                                <th className='w-[170px] w-full font-normal px-2'>
                                    <select className='bg-[#F9F9F9] outline-none cursor-pointer hover:bg-gray-100 p-2 rounded'>
                                ...
                                <th className='flex justify-center w-[120px] w-full gap-1'>
                                    <button className='flex items-center w-fit h-fit bg-black rounded p-2 text-white font-normal gap-1.5 px-3 hover:bg-gray-800'>
                                    ...
                                    <button className='w-fit h-fit bg-black rounded p-3 hover:bg-gray-800'>
